  ...
  <!-- KONTEN BODY AWAL -->
    ...
    <?php
      ...
      <input type="hidden" name="hapusberhasil" value="3" />
               ...
               $sql2 = "insert into $tabeldatabase (userna_me, pa_ssword, nama, alamat, nohp, tgllahir, tglaktif, jabatan, avatar) values( '$username','$password','$nama','$alamat','$nohp','$tgllahir','$tglaktif','$jabatan','$avatar')";
