          ...
          <form class="form-horizontal" method="post" action="add_<?php echo $halaman; ?>" id="Myform">
              <div class="box-body">
				...
				<div class="row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $nama; ?>" placeholder="Masukan Nama Merk/Brand" maxlength="50">
                  </div>
                </div>
				</div>
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $result=mysqli_query($conn,$sql);
          ...
          echo "<script type='text/javascript'>window.location = '$forwardpage';</script>";
					 ...
					 $sql2 = "insert into $tabeldatabase (kode, nama) values( '$kode','$nama')";
