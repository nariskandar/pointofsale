...
if($get == '1'){
  ...
  // die;
  // var_dump($stokeceranterjual);die;



   $sqll3 = "UPDATE barang SET terjual='$terjualakhir', sisa='$sisaakhir', stokeceran ='$stokeceran', terjualeceran ='$terjualeceran' where barcode='$barang'";
...
if($jumlah >= $terbeliawal){
  ...
  // var_dump($sisaakhir);die;


   $sql3 = "UPDATE barang SET terbeli='$terbeliakhir', sisa='$sisaakhir' where barcode='$barang'";
