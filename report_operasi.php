                  ...
                  <div class="row">
                    <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-aqua">
                                           <div class="inner">
                                               <h3><sup style="font-size: 20px">Rp </sup><?php echo number_format($data14, $decimal, $a_decimal, $thousand).',-'; ?></h3>
                                               <p>Total Semua</p>
                                           </div>
                                           <div class="icon">
                                   ...
                                   <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-yellow">
                                           <div class="inner">
                                               <h3><sup style="font-size: 20px">Rp </sup><?php echo number_format($data24, $decimal, $a_decimal, $thousand).',-'; ?></h3>
                                               <p>Total Tahun Ini</p>
                                           </div>
                                           <div class="icon">
                                              <i class="ion ion-stats-bars"></i>
                    ...
                    <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-green">
                                           <div class="inner">
                                               <h3><sup style="font-size: 20px">Rp </sup><?php echo number_format($data34, $decimal, $a_decimal, $thousand).',-'; ?></h3>
                                               <p>Total Bulan Ini</p>
                                           </div>
                                           <div class="icon">
                                               <i class="ion ion-stats-bars"></i>
                                   ...
                                   <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-red">
                                           <div class="inner">
                                               <h3><sup style="font-size: 20px">Rp </sup><?php echo number_format($data44, $decimal, $a_decimal, $thousand).',-'; ?></h3>
                                               <p>Total Hari Ini</p>
                                           </div>
                                           <div class="icon">
                                               <i class="ion ion-stats-bars"></i>
...
if($tahun == null || $tahun == "" ){
        ...
        $sqla="SELECT no, COUNT( * ) AS totaldata FROM $forward where tanggal LIKE '$tahun-$bulan-%'";
      }
...
<div class="col-lg-6 col-md-6 col-sm-6">
  <?php
$sqlb="SELECT SUM(biaya) AS total FROM $forward WHERE tanggal LIKE '$tahun-$bulan-%'";
$hasila=mysqli_query($conn,$sqlb);
$rowa=mysqli_fetch_assoc($hasila);
$totaloperasi=$rowa['total'];
...
<?php if($tahun != null || $tahun != ""){ ?>
                    ...
                    <?php echo 'Biaya Opersional pada bulan <b>'.$namabulan.'</b> '.$tahun.' sejumlah <b>Rp '.number_format($totaloperasi, $decimal, $a_decimal, $thousand).',-</b>'; ?>
                </div>
                  <?php }else{} ?>
</div>
                </div>
 ...
 ?>
     ...
     if ($tahun != null || $tahun != "") {
         ...
         $query1="SELECT * FROM  $forward where tanggal like '$tahun-$bulan-%' order by no limit $rpp";
